...
<body>
	...
	<script>
		...
		function regist() {
			...
			//세선에서 현재 로그인 중인 사용자의 정보(아이디)를 얻어오자.
		...
		$contentDiv.addEventListener('click', e => {
			...
			.then(data => {
				console.log(data);
				// document.getElementById('snsWriter').value = 
				// document.getElementById('snsRegDate').value = 
				// document.getElementById('snsContent').value = 
				// $('snsModal').modal('show');
